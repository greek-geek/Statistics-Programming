...
#
#     Py_coef = regr.coef_
#     Py_intercept = regr.intercept_
#     my_coef = myLinearRegression(X, Y)
#
#     print("c  oefficient of python are "+str(Py_intercept)+str(Py_coef))
#     print("coefficient of myfunc are "+str(my_coef))
#
